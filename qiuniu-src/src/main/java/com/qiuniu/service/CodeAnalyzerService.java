...
public class CodeAnalyzerService {
    ...
    public void analyzeRepo(String repoUrl, String branch, String projectName,
        ...
        try {
            ...
            if (totalFiles == 0) {
                ...
                reportDAO.finish(reportId, finalReport, 0, System.currentTimeMillis() - startMs);
            ...
            reportDAO.finish(reportId, summary, totalIssues, System.currentTimeMillis() - startMs);
    ...
    public String analyzeFileList(List<FileInfo> files, String ruleSetId, String projectName) {
        ...
        return summarizeReport(projectName, null, ruleSet.getName(), results, System.currentTimeMillis(), false);
    }
