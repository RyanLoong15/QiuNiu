...
public class ChatServlet extends HttpServlet {
    ...
    private static final String FLASK_RAG_URL = "http://localhost:5001";
    ...
    private void sendMessage(HttpServletRequest request, HttpServletResponse response, User user)
        ...
        Integer topK = data.get("top_k") != null ? ((Double) data.get("top_k")).intValue() : 5;
        ...
        Map<String, Object> ragResult = callFlaskRAG(query.trim(), history, topK);
     ...
     * 调用Flask RAG服务（带历史上下文）
     */
    private Map<String, Object> callFlaskRAG(String query, List<ChatMessage> history, int topK)
            throws Exception {

        URL url = new URL(FLASK_RAG_URL + "/chat");
